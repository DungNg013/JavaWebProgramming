 ...
 * @author Dell E5440
 */
@WebServlet(urlPatterns = {"/regiter"})
...
//            userModel.insert(user);
            ...
            out.println("<h5>Your infomation</h5>");
            out.println("<table border=\"1\">"); 
            out.println("<tr>");    
            out.println("<td>name</td>");        
            out.println("<td>value</td>");        
            out.println("</tr>");
            Enumeration<String> paName = request.getParameterNames();
            while(paName.hasMoreElements()){
                String pname = paName.nextElement();
                out.println(" <tr>");   
                out.println("<td>"+ pname +"</td>");        
                out.println("<td>"+ request.getParameter(pname) +"</td>");        
                out.println("</tr>");  
            }
